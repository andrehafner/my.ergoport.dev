...
print "### Min Price Checker ###\n";
print $printamountchecker;
print "\n";
print " Min: \$$min in $currency";
print "\n";
print " Min: $minADA in ADA";
print "\n";
print " Min: $ergADA in ERG";
print "\n";
