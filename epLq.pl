...
print "### LQ Price Checker ###\n";
print $printamountchecker;
print "\n";
print "   LQ: \$$lq in $currency";
print "\n";
print "   LQ: $lqADA in ADA";
print "\n";
print "   LQ: $ergADA in ERG";
print "\n";
