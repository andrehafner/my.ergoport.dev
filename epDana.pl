...
print "### Dana Price Checker ###\n";
print $printamountchecker;
print "\n";
print "Dana: \$$dana in $currency";
print "\n";
print "Dana: $danaADA in ADA";
print "\n";
print "Dana: $ergADA in ERG";
print "\n";
