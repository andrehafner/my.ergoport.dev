...
my $idclean = $id;
$idclean =~ s/[^0-9.]+//g;
my $amountchecker = ($idclean * $hosky);
...
print "### Hosky Price Checker ###\n";
print $printamountchecker;
print "\n";
print "Hosky: \$$hosky in $currency";
print "\n";
print "Hosky: $hoskyADA in ADA";
print "\n";
print "Hosky: $ergADA in ERG";
print "\n";
