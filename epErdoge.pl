...
my $ergADA = ($erdoge / $ada);

#price checker
my $fullid = $id;
my $idclean = $id;
$idclean =~ s/[^0-9.]+//g;
my $amountchecker = ($idclean * $erdoge);
...
$erdogeERG = ($erdoge / $erg);

print "### Erdoge Price Checker ###\n";
print $printamountchecker;
print "\n";
print "Erdoge: \$$erdoge in $currency";
print "\n";
print "Erdoge: $erdogeERG in ERG";
print "\n";
print "Erdoge: $ergADA in ADA";
print "\n";
