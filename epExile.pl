...
my $idclean = $id;
$idclean =~ s/[^0-9.]+//g;
my $amountchecker = ($idclean * $exile);
...
print "### Exile Price Checker ###\n";
print $printamountchecker;
print "\n";
print "Exile: \$$exile in $currency";
print "\n";
print "Exile: $exileERG in ERG";
print "\n";
print "Exile: $ergADA in ADA";
print "\n";
