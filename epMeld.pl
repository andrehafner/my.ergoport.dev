...
print "### Meld Price Checker ###\n";
print $printamountchecker;
print "\n";
print "Meld: \$$meld in $currency";
print "\n";
print "Meld: $meldADA in ADA";
print "\n";
print "Meld: $ergADA in ERG";
print "\n";
