...
my $idclean = $id;
$idclean =~ s/[^0-9.]+//g;
my $amountchecker = ($idclean * $pavia);
...
print "### Pavia Price Checker ###\n";
print $printamountchecker;
print "\n";
print "Pavia: \$$pavia in $currency";
print "\n";
print "Pavia: $paviaADA in ADA";
print "\n";
print "Pavia: $ergADA in ERG";
print "\n";
