...
my $idclean = $id;
$idclean =~ s/[^0-9.]+//g;
my $amountchecker = ($idclean * $comet);
...
print "### Comet Price Checker ###\n";
print $printamountchecker;
print "\n";
print "Comet: \$$comet in $currency";
print "\n";
print "Comet: $cometERG in ERG";
print "\n";
print "Comet: $ergADA in ADA";
print "\n";
