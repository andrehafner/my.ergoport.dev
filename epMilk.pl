...
my $idclean = $id;
$idclean =~ s/[^0-9.]+//g;
my $amountchecker = ($idclean * $XXX);
my $amountcheckerTOKEN = ($amountchecker / $ada);
my $printamountchecker = "\n$id = \$$amountchecker USD \n$id = $amountcheckerTOKEN ADA \n";
...
my $idclean = $id;
$idclean =~ s/[^0-9.]+//g;
my $amountchecker = ($idclean * $milk);
my $amountcheckerTOKEN = ($amountchecker / $ada);

my $printamountchecker = "\n$idclean Milk x \$$milk (Milk Price) = \$$amountchecker USD \n\$$amountchecker USD / \$$ada (ADA Price) = $amountcheckerTOKEN ADA \n";
...
print "### Milk Price Checker ###\n";
print $printamountchecker;
print "\n";
print "Milk: \$$milk in USD";
print "\n";
print "Milk: $milkADA in ADA";
print "\n";
