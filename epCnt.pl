...
print "### CNT Price Checker ###\n";
print $printamountchecker;
print "\n";
print "CNT: \$$cnt in $currency";
print "\n";
print "CNT: $cntADA in ADA";
print "\n";
print "CNT: $ergADA in ERG";
print "\n";
